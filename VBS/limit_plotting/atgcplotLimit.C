...
{
  if (parname.EqualTo("param1") )  return "F_{S0}/#lambda^{4} (100 TeV^{-4})";
  if (parname.EqualTo("param2") ) return "F_{S1}/#lambda^{4} (100 TeV^{-4})";
...
{
  if (parname.EqualTo("param1") )  return -2.5;
  if (parname.EqualTo("param2") ) return -2.5;
...
{
  if (parname.EqualTo("param1") )  return 0.01;
  if (parname.EqualTo("param2") ) return 0.01;
...
void atgcplotLimit()
{
  ...
  fnames.push_back("/home/anlevin/atgc_fw_2/CMSSW_6_1_1/src/CombinedEWKAnalysis/CommonTools/test/higgsCombineTest.MultiDimFit.mH120.expected.root");
  fnames.push_back("/home/anlevin/atgc_fw_2/CMSSW_6_1_1/src/CombinedEWKAnalysis/CommonTools/test/higgsCombineTest.MultiDimFit.mH120.observed.root");
